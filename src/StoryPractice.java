...
public class StoryPractice {
	...
	public static void main(String[] args) {
		...
		System.out.println("Kai-Yun and his merry student band could not take anything seriously, they were always monkeying around.");
		...
		System.out.println("Kai-Yun's student allies fought hard but were no match for the stronger gorillas.");
